...
l1encounters m = powerDict m [myGrandma, perfectChance, defensiveTac, dontGiveUp]
l1echosen m = powerlookup m "warlord-enc1" l1encounters
...
battlecry m = case (getResponse m "warlord-special") of
  Nothing -> []
  Just x -> [quickSpecial (x ++ " Battlecry") m]

biggerBag m = quickPower "Bigger Punching Bag" Attack Encounter -5 0 -1 Purple m
leadCharge m = quickPower "Lead The Charge" Attack Encounter 0 0 0 Purple m
alwaysInPosition m = quickPower "Always in Position" Attack Encounter 0 0 4 Purple m
ultimatum m = quickPower "Ultimatum" Attack Encounter 0 0 0 Purple m
